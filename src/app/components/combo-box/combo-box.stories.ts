...
type Story = StoryObj<ComboBoxBasicComponent>;
...
Basic.parameters = {
  preview: [
    ...generateConfig(
      "components/combo-box/combo-box-basic",
      "ComboBoxBasicModule",
      "combo-box-basic",
    ),
    {
...
CustomTemplate.parameters = {
  preview: [
    ...generateConfig(
      "components/combo-box/combo-box-template",
      "ComboBoxTemplateModule",
      "combo-box-template",
    ),
    {
